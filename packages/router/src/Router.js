...
Ext.define('router.Router', {
        ...
        processRoutes: function() {
            ...
            if (!appRoutes && Ext.isDefined(Ext.global.console)) {
                Ext.global.console.warn("[router.Router] No routes were found. Consider defining routes object in your Ext.application definition.");
            }
            //</debug>
        ...
        routeMatcher: function(route, rules) {
            ...
            if (!routeObj.controller && Ext.isDefined(Ext.global.console)) {
                Ext.global.console.error("[router.Router] Config 'controller' can't be undefined", route, rules);
            }

            if (!routeObj.action && Ext.isDefined(Ext.global.console)) {
                Ext.global.console.error("[router.Router] Config 'action' can't be undefined", route, rules);
            }
            //</debug>
        ...
        dispatch: function(token, route, params) {
            ...
            if (!controller && Ext.isDefined(Ext.global.console)) {
                Ext.global.console.error("[router.Router] Controller not found ", route.controller);
            }
            //</debug>
            ...
            if (!controller[route.action] && Ext.isDefined(Ext.global.console)) {
                Ext.global.console.error("[router.Router] Controller action not found ", route.controller, route.action);
            }
            //</debug>
